...
export const NavbarAdminHotel = () => {
    ...
    return (
        <StyledNavbar>
            <ul className='navbar'>
            <li onClick={() => goToPage('/home/zaru/homeAdmin')} className='logo-container'>
                    <a> <img src={logo} alt="Logo" width={50}  /> </a>
                </li> 
                <li onClick={() => goToPage('/home/zaru/roomsAdminHotel')} className='ocultarElementos'>
                    <a href="#">Rooms</a>
                </li>
                <li onClick={() => goToPage('/home/zaru/reservasAdminHotel')} className='ocultarElementos'>
                    <a href="#">Reservations</a>
                </li>
                <li onClick={() => goToPage('/home/zaru/hotelsAdminHotel')} className='ocultarElementos'>
                    <a href="#">Hotels</a>
                </li>
                <li onClick={() => goToPage('/home/zaru/servicesAdminHotel')} className='ocultarElementos'>
                    <a href="#">Services</a>
                </li>
